...
public class Homework2 {
        ...
        public void fromCssToxPath(){
            ...
            wd.findElement(By.xpath("*[starts-with(@href, 'no'"));

            wd.findElement(By.cssSelector("div.focus"));
            wd.findElement(By.cssSelector("//div*[@class='container']"));
            ...
            wd.findElement(By.xpath("//table*[@id='contry'] tr[2]//td[last()]"));
        ...
        public void fromXPathToCss(){
            ...
            wd.findElement(By.cssSelector("//div.first and .list"));

            wd.findElement(By.xpath("//div[contains(@class,'st']"));
            wd.findElement(By.cssSelector("div.class[attribute = 'st'"));

            wd.findElement(By.xpath("//div[@id=’idName’]//h1[last()]"));
            wd.findElement(By.xpath("div#idName"));
